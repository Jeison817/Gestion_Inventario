...
<body>
   ...
   <header>
      <div class="flex gap-4 bg-green-600 justify-center h-[50px] items-center">
         ...
         <a href="/Gestion_Inventario/Categorias" class="h-auto text-white hover:bg-green-700 p-2 rounded-md cursor-pointer border border-white border-solid"> Categorias </a>
        ...
        <div class="flex w-full justify-center p-4 gap-4 flex-wrap">  
          ...
          %>
            ...
            <div class="flex bg-gray-200 w-[200px] justify-center flex-col p-4 gap-2 items-center rounded-md border border-gray-300 border-solid hover:border-green-600 cursor-pointer">
                  <!-- Asegúrate de que la URL de la imagen esté correctamente insertada -->
                  ...
                  <!-- Corregí el nombre del método 'getDescripcion' en vez de 'getDescripsion' -->
            </div>
