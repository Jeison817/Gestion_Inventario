...
// Importamos las librerias nesesarias para el funcionamiento 
import java.io.Reader;  // Libreria (clase) para leer archivos de configuracion
import org.apache.ibatis.io.Resources; // Libreria que importa los archivos de los recursos "En mi caso" --> my-batis-config.xml
import org.apache.ibatis.session.SqlSessionFactory; // Libreria que se usa para la interaccion entre java y sql (basse de datos)
import org.apache.ibatis.session.SqlSessionFactoryBuilder; // Libreria que contruye archivos "instancia(sesion)" de funcionamiento a partir del archivo xml
